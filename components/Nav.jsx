...
const Nav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full p-0 z-50 bg-white border-b">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-black/80 border-t border-white flex-row justify-center ">
          <div className="px-4 py-4 flex flex-row flex-wrap justify-center gap-2">
...
const NavLink = ({ href, label, onClick }) => (
  <Link
    href={href}
    onClick={onClick}
    className=" text-black hover:text-gray-500 rounded-lg px-3 py-2 text-lg transition duration-300"
  >
    {label}
  </Link>
);
